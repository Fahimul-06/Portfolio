...
export function LiveChatWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-16 right-3 z-50 flex h-[600px] max-h-[calc(100vh-5rem)] w-[calc(100vw-1.5rem)] max-w-sm flex-col overflow-hidden rounded-2xl border border-violet-400/30 bg-[#0b0614] shadow-2xl shadow-violet-500/20 sm:right-5">
